! function (e, t) {
    ...
    var j, _ = function () {
            ...
            return c(n, [{
                ...
                value: function () {
                    var e;
                    console.warn("You are not allowed to use DEVTOOLS! 【type = ".concat(this.type, "】")), w.clearIntervalWhenDevOpenTrigger && y(), window.clearTimeout($), w.ondevtoolopen(this.type, ee), e = this.type, t[e] = !0
                }
            }, {
                key: "init",
                value: function () {}
